...
//estado para array ou objeto => manualmente informar o tipo de variável
interface Item {
    id: number;
    title: string;
    image_url: string;
...
const CreatePoint = () => {
    ...
    async function handleSubmit(event: FormEvent) {
        event.preventDefault(); //evita o submit ir pra outra tela
